...
export  async function GET(req, res) {
    ...
    const minPrice = price - 4000;
    const maxPrice = price + 4000;
        ...
        try {
            ...
            data = await collection.find({price: {$gte: minPrice, $lte: maxPrice} }).collation({ locale: "en", strength: 2 }).limit(limit).toArray();
         console.log(data)
