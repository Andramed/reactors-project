...
export default function Product({item, getProductToCart, getProduct, showElements}) {
          ...
          <div className='flex justify-evenly gap-2 items-center px-5 text-sm'>
            <div>{item.price} lei </div>
              <div className='flex justify-between gap-1'>
                ...
                <button onClick={()=>getProductToCart(item)} className='bg-btn-color px-1 py-1 rounded-[0.5rem] hover:scale-125'>
